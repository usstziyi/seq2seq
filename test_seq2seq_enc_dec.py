...
from decoder import BasicEncoderDecoder
import collections
...
def train_seq2seq(net, data_iter, lr, num_epochs, tgt_vocab, device):
    ...
    # 初始化绘图
    fig, ax, line, x_list, y_list = dl.init_plot(lr, title='Training loss vs Epoch (Seq2Seq Encoder-Decoder)')
...
def main():
    ...
    net = BasicEncoderDecoder(encoder, decoder)
